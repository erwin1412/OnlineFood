...
const file_proto_transaction_proto_rawDesc = "" +
	...
	"\x11DeleteTransaction\x12%.transaction.DeleteTransactionRequest\x1a&.transaction.DeleteTransactionResponseB*Z(internal/delivery/grpc/pb/transaction;pbb\x06proto3"
