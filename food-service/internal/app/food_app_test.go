...
// func (m *mockMerchantClient) GetMerchantByID(ctx context.Context, id string) (*domain.Merchant, error) {
// 	return &domain.Merchant{ID: id, Name: "Mock Merchant"}, nil
// }
...
// 	appSvc := app.NewFoodApp(mockRepo, &mockProducer{}, mockMerchantClient)
