...
func (x *EmptyFood) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EmptyFood) ProtoMessage() {}

func (x *EmptyFood) ProtoReflect() protoreflect.Message {
	mi := &file_proto_food_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EmptyFood.ProtoReflect.Descriptor instead.
func (*EmptyFood) Descriptor() ([]byte, []int) {
...
const file_proto_food_proto_rawDesc = "" +
	...
	"\vFoodService\x129\n" +
	"\n" +
	"CreateFood\x12\x17.food.CreateFoodRequest\x1a\x12.food.FoodResponse\x125\n" +
	"\n" +
	"GetAllFood\x12\x0f.food.EmptyFood\x1a\x16.food.FoodListResponse\x12;\n" +
...
var file_proto_food_proto_goTypes = []any{
	...
	(*EmptyFood)(nil),             // 8: food.EmptyFood
...
var file_proto_food_proto_depIdxs = []int32{
	...
	8, // 5: food.FoodService.GetAllFood:input_type -> food.EmptyFood
